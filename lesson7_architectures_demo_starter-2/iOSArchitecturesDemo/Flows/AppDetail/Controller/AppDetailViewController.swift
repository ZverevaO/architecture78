...
final class AppDetailViewController: UIViewController {
    ...
    private func addHeaderViewController() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.headerViewController.view.leftAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.leftAnchor),
            self.headerViewController.view.rightAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.rightAnchor)
        ])
    }
    
    private func addDescriptionViewController() {
        // TODO: ДЗ, сдедать другие сабмодули
